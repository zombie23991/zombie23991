...
I am a **CEO / CTPO** and product-driven builder focused on creating software that solves painful business problems with clarity, speed, and taste.

My strength is not being only a programmer, only a designer, or only a business profile. My edge is being hybrid by default: business vision, product judgment, frontend execution, backend ownership, AI-native thinking, and startup speed.

I like being close to the problem, close to the user, and close to the code. That combination helps me understand not only what we are building, but why it matters, where the value is, and how to turn it into a product people can actually use.
...
<details>
<summary><strong>Verbum Quest & Ekoora — Product experimentation</strong></summary>

<br>

Before Intake, I built and explored different product ideas that helped sharpen my ability to move from problem to interface to working software.
